...
This repository contains a hardened, honest workshop-only robotics paper draft for `deformable_memory_under_action`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/75.pdf`
