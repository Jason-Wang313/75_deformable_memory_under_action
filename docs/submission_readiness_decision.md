...
Honest strongest claim: `Model deformable-object memory as action-conditioned hidden state, not visual appearance.` is a plausible branch-structured mechanism for deformable object manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
