...
\usepackage{url}
\usepackage{booktabs}
\title{Deformable Memory Under Action: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about deformable object manipulation. The original research bet was: Model deformable-object memory as action-conditioned hidden state, not visual appearance. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Learning Language-Conditioned Deformable Object Manipulation with Graph Dynamics (2023)
\item Action-conditional implicit visual dynamics for deformable object manipulation (2024)
\item Visual object detection with deformable part models (2013)
\item Learning Foresightful Dense Visual Affordance for Deformable Object Manipulation (2023)
\item Learning Dynamic Compact Memory Embedding for Deformable Visual Object Tracking (2024)
\end{itemize}
